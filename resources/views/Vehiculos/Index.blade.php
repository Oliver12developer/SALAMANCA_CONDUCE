...
@section('content')
    <p>Bienvenido al panel de administración de vehículos</p>

    <div class="container">

        <!-- Button trigger modal -->
        <button type="button" class="btn btn-primary mt-4 mb-3" data-bs-toggle="modal" data-bs-target="#exampleModal">
            <i class="bi bi-taxi-front-fill mr-2"></i>Agregar Vehículo
        </button>
                            ...
                            <div class="row">
                                <div class="col">
                                    <input id="modelo" name="modelo" type="text" class="form-control"
                                        placeholder="Modelo" aria-label="modelo" required>
                                </div>
                                <div class="col">
                                    <input id="placa" name="placa" type="placa" class="form-control"
                                        placeholder="Placa" aria-label="placa" required maxlength="9">
                                </div>
                            </div>
                ...
                @foreach ($vehiculos as $vehiculo)
                    <tr>
                        ...
                        <td>
                            ...
                            <!--Boton editar-->
                            <button type="button" class="btn btn-outline-primary" data-bs-toggle="modal" style="border: 0ch;"
                                data-bs-target="#editModal{{ $vehiculo->id }}">
                            ...
                            <!-- Modal Editar-->
                            <div class="modal fade" id="editModal{{ $vehiculo->id }}" tabindex="-1"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col">
                                                        <input id="placa" name="placa" type="placa"
                                                            ...
                                                            value="{{ $vehiculo->placa }}" required maxlength="9">
                                                    </div>
                                                </div>
                                                <div class="modal-footer">
                            ...
                            <!--Boton eliminar-->
                            <form class="btn btn-outline-danger" action="{{ route('vehiculos.destroy', $vehiculo->id) }}" style="border: 0ch;"
                                method="POST">
                                @csrf
                                @method('DELETE')
